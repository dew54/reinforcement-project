...
import sys
from algos.agents.double_dqn_agent import Double_DQNAgent
sys.path.append('../../')
...
doubleAgent = Double_DQNAgent(INPUT_SHAPE, ACTION_SIZE, SEED, device, BUFFER_SIZE, BATCH_SIZE, GAMMA, LR, TAU, UPDATE_EVERY, UPDATE_TARGET, DQNCnn)
...
plt.ylabel('Score')
plt.xlabel('Episode #')
plt.savefig('scores_on_episodes')
